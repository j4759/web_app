...
App Logs are captured by cloudwatch with the ability to toggle on/off cloudtrail and vpc flow logs in the tfvars for each environment.
...
Future automation should include additional testing before deployment and a automated build for the image.
